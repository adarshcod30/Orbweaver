...
--shadow:0 2px 4px rgba(0,0,0,.32),0 8px 20px -4px rgba(0,0,0,.4);
...
.bar{display:flex;flex-wrap:wrap;gap:24px;padding:16px 20px;background:var(--surface);
...
.card,.row{transition:border-color 200ms var(--ease),box-shadow 200ms var(--ease)}
.htmx-settling{opacity:.001}
*{transition-property:border-color,box-shadow,opacity;transition-duration:200ms;
