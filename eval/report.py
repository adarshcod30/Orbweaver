...
<script>document.documentElement.className += " js-boot";</script>
<style>{CASE_CSS}
[hidden]{{display:none!important}}
.js-boot .panel:not(#p-overview){{display:none}}
...
<noscript><style>.tabs{{display:none}}</style></noscript>
</div>
</header>
<div class="wrap">
...
<section class="panel" id="p-method" role="tabpanel" aria-labelledby="t-method">
...
<section class="panel" id="p-figures" role="tabpanel" aria-labelledby="t-figures">
...
<section class="panel" id="p-failures" role="tabpanel" aria-labelledby="t-failures">
...
<section class="panel" id="p-research" role="tabpanel" aria-labelledby="t-research">
...
(function(){{
  ...
  document.documentElement.className =
    document.documentElement.className.replace(/\bjs-boot\b/, '');
